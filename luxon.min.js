...
class e extends Error {} class r extends e {constructor(e) {super(`Invalid DateTime: ${e.toMessage()}`);}} class n extends e {constructor(e) {super(`Invalid Interval: ${e.toMessage()}`);}} class s extends e {constructor(e) {super(`Invalid Duration: ${e.toMessage()}`);}} class N extends e {} class i extends e {constructor(e) {super(`Invalid unit ${e}`);}} class a extends e {} class o extends e {constructor() {super('Zone is an abstract class');}} var t = 'numeric'; var u = 'short'; var l = 'long'; const c = { year: t, month: t, day: t }; const h = { year: t, month: u, day: t }; const d = {
  ...
  static macroTokenToFormatOpts(e) { return pe[e]; }
...
}let be = null; class Oe extends Se {
  static get instance() { return be === null && (be = new Oe()), be; }
  ...
  offset(e) {
    ...
    })), Me[o]); var [n, s, i, a, e, o] = (r.formatToParts ? function (e, t) { const r = e.formatToParts(t); const n = []; for (let e = 0; e < r.length; e++) { var { type: s, value: i } = r[e]; var s = Ne[s]; $(s) || (n[s] = parseInt(i, 10)); } return n; } : function (e, t) { var r = e.format(t).replace(/\u200E/g, ''); var [, n, s, i, e, t, r] = /(\d+)\/(\d+)\/(\d+),? (\d+):(\d+):(\d+)/.exec(r); return [i, n, s, e, t, r]; })(r, t); var r = +t; var t = r % 1e3; return (Y({
...
} function Ce(e, t) { if ($(e) || e === null) return t; if (e instanceof Se) return e; if (typeof e !== 'string') return Z(e) ? Ie.instance(e) : typeof e === 'object' && e.offset && typeof e.offset === 'number' ? e : new xe(e); const r = e.toLowerCase(); return r === 'local' || r === 'system' ? t : r === 'utc' || r === 'gmt' ? Ie.utcInstance : Ee.isValidSpecifier(r) ? Ee.create(e) : Ie.parseSpecifier(r) || new xe(e); }let $e = () => Date.now(); let Ze = 'system'; let Fe = null; let Le = null; let ze = null; let qe; class Ae {
  static get now() { return $e; }

  static set now(e) { $e = e; }

  static set defaultZone(e) { Ze = e; }

  static get defaultZone() { return Ce(Ze, Oe.instance); }
  ...
  static resetCaches() { Ge.resetCache(), Ee.resetCache(); }
}let je = {}; function _e(e, t = {}) { const r = JSON.stringify([e, t]); let n = je[r]; return n || (n = new Intl.DateTimeFormat(e, t), je[r] = n), n; }let Ue = {}; let He = {}; let We = null; function Re(e, t, r, n, s) { r = e.listingMode(r); return r === 'error' ? null : (r === 'en' ? n : s)(t); } class Pe {
  constructor(e, t, r) { if (this.padTo = r.padTo || 0, this.floor = r.floor || !1, !t) { const n = { useGrouping: !1 }; r.padTo > 0 && (n.minimumIntegerDigits = r.padTo), this.inf = (function (e, t = {}) { const r = JSON.stringify([e, t]); let n = Ue[r]; return n || (n = new Intl.NumberFormat(e, t), Ue[r] = n), n; }(e, n)); } }

  format(e) { if (this.inf) { const t = this.floor ? Math.floor(e) : e; return this.inf.format(t); } return j(this.floor ? Math.floor(e) : W(e, 3), this.padTo); }
} class Je {
  ...
  constructor(e, t, r) { this.opts = { style: 'long', ...r }, !t && L() && (this.rtf = (function (e, t = {}) { const { base: r, ...n } = t; const s = JSON.stringify([e, n]); let i = He[s]; return i || (i = new Intl.RelativeTimeFormat(e, t), He[s] = i), i; }(e, r))); }
  ...
  static resetCache() { We = null, je = {}, Ue = {}, He = {}; }
  ...
  months(r, n = !1, e = !0) { return Re(this, r, e, oe, () => { const t = n ? { month: r, day: 'numeric' } : { month: r }; const e = n ? 'format' : 'standalone'; return this.monthsCache[e][r] || (this.monthsCache[e][r] = (function (t) { const r = []; for (let e = 1; e <= 12; e++) { const n = Wr.utc(2016, e, 1); r.push(t(n)); } return r; }((e) => this.extract(e, t, 'month')))), this.monthsCache[e][r]; }); }
  ...
  meridiems(e = !0) { return Re(this, void 0, e, () => de, () => { if (!this.meridiemCache) { const t = { hour: 'numeric', hourCycle: 'h12' }; this.meridiemCache = [Wr.utc(2016, 11, 13, 9), Wr.utc(2016, 11, 13, 19)].map((e) => this.extract(e, t, 'dayperiod')); } return this.meridiemCache; }); }

  eras(e, t = !0) { return Re(this, e, t, ge, () => { const t = { era: e }; return this.eraCache[e] || (this.eraCache[e] = [Wr.utc(-40, 1, 1), Wr.utc(2017, 1, 1)].map((e) => this.extract(e, t, 'era'))), this.eraCache[e]; }); }
...
} function Be(...e) { e = e.reduce((e, t) => e + t.source, ''); return RegExp(`^${e}$`); } function Qe(...e) { return (i) => e.reduce(([e, t, r], n) => { var [s, n, r] = n(i, r); return [{ ...e, ...s }, t || n, r]; }, [{}, null, 1]).slice(0, 2); } function Ke(e, ...t) { if (e == null) return [null, null]; for (let[r, n] of t) { r = r.exec(e); if (r) return n(r); } return [null, null]; } function Xe(...s) { return (e, t) => { const r = {}; let n; for (n = 0; n < s.length; n++)r[s[n]] = _(e[t + n]); return [r, null, t + n]; }; } var et = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/; const tt = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/; const rt = RegExp(`${tt.source}${et.source}?`); var u = RegExp(`(?:T${rt.source})?`); var t = Xe('weekYear', 'weekNumber', 'weekDay'); var l = Xe('year', 'ordinal'); var et = RegExp(`${tt.source} ?(?:${et.source}|(${ne.source}))?`); var ne = RegExp(`(?: ${et.source})?`); function nt(e, t, r) { t = e[t]; return $(t) ? r : _(t); } function st(e, t) { return [{ year: nt(e, t), month: nt(e, t + 1, 1), day: nt(e, t + 2, 1) }, null, t + 3]; } function it(e, t) {
  return [{
    hours: nt(e, t, 0), minutes: nt(e, t + 1, 0), seconds: nt(e, t + 2, 0), milliseconds: H(e[t + 3]),
  }, null, t + 4];
} function at(e, t) { const r = !e[t] && !e[t + 1]; var e = K(e[t + 1], e[t + 2]); return [{}, r ? null : Ie.instance(e), t + 3]; } function ot(e, t) { return [{}, e[t] ? Ee.create(e[t]) : null, t + 1]; } const ut = RegExp(`^T?${tt.source}$`); const lt = /^-?P(?:(?:(-?\d{1,9}(?:\.\d{1,9})?)Y)?(?:(-?\d{1,9}(?:\.\d{1,9})?)M)?(?:(-?\d{1,9}(?:\.\d{1,9})?)W)?(?:(-?\d{1,9}(?:\.\d{1,9})?)D)?(?:T(?:(-?\d{1,9}(?:\.\d{1,9})?)H)?(?:(-?\d{1,9}(?:\.\d{1,9})?)M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,9}))?S)?)?)$/; function ct(e) {
  let[t, r, n, s, i, a, o, u, l] = e; const c = t[0] === '-'; e = u && u[0] === '-', t = (e, t = !1) => (void 0 !== e && (t || e && c) ? -e : e); return [{
    years: t(U(r)), months: t(U(n)), weeks: t(U(s)), days: t(U(i)), hours: t(U(a)), minutes: t(U(o)), seconds: t(U(u), u === '-0'), milliseconds: t(H(l), e),
  }];
} const ht = {
  GMT: 0, EDT: -240, EST: -300, CDT: -300, CST: -360, MDT: -360, MST: -420, PDT: -420, PST: -480,
}; function dt(e, t, r, n, s, i, a) {
  const o = {
    year: t.length === 2 ? B(_(t)) : _(t), month: ie.indexOf(r) + 1, day: _(n), hour: _(s), minute: _(i),
  }; return a && (o.second = _(a)), e && (o.weekday = e.length > 3 ? ue.indexOf(e) + 1 : le.indexOf(e) + 1), o;
} const mt = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|(?:([+-]\d\d)(\d\d)))$/; function ft(e) { var [, t, r, n, s, i, a, o, u, l, c, e] = e; var o = dt(t, s, n, r, i, a, o); let h; return h = u ? ht[u] : l ? 0 : K(c, e), [o, new Ie(h)]; } const yt = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun), (\d\d) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (\d{4}) (\d\d):(\d\d):(\d\d) GMT$/; const gt = /^(Monday|Tuesday|Wedsday|Thursday|Friday|Saturday|Sunday), (\d\d)-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-(\d\d) (\d\d):(\d\d):(\d\d) GMT$/; const wt = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) ( \d|\d\d) (\d\d):(\d\d):(\d\d) (\d{4})$/; function pt(e) { var [, t, r, n, s, i, a, e] = e; return [dt(t, s, n, r, i, a, e), Ie.utcInstance]; } function vt(e) { var [, t, r, n, s, i, a, e] = e; return [dt(t, e, r, n, s, i, a), Ie.utcInstance]; } const Tt = Be(/([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, u); const St = Be(/(\d{4})-?W(\d\d)(?:-?(\d))?/, u); const bt = Be(/(\d{4})-?(\d{3})/, u); const Ot = Be(rt); const kt = Qe(st, it, at); const Mt = Qe(t, it, at); const Nt = Qe(l, it, at); const Dt = Qe(it, at); const Et = Qe(it); const Vt = Be(/(\d{4})-(\d\d)-(\d\d)/, ne); const It = Be(et); const xt = Qe(st, it, at, ot); const Ct = Qe(it, at, ot); const $t = {
  weeks: {
  ...
  ...$t,
}; const Ft = 365.2425; const Lt = 30.436875; const zt = {
  years: {
  ...
  months: {
    weeks: Lt / 7, days: Lt, hours: 24 * Lt, minutes: 43829.1, seconds: 2629746, milliseconds: 2629746e3,
  },
  ...$t,
}; const qt = ['years', 'quarters', 'months', 'weeks', 'days', 'hours', 'minutes', 'seconds', 'milliseconds']; const At = qt.slice(0).reverse(); function jt(e, t, r = !1) { e = { values: r ? t.values : { ...e.values, ...t.values || {} }, loc: e.loc.clone(t.loc), conversionAccuracy: t.conversionAccuracy || e.conversionAccuracy }; return new Ut(e); } function _t(e, t, r, n, s) { const i = e[s][r]; var a = t[r] / i; var a = !(Math.sign(a) === Math.sign(n[s])) && n[s] !== 0 && Math.abs(a) <= 1 ? (e = a) < 0 ? Math.floor(e) : Math.ceil(e) : Math.trunc(a); n[s] += a, t[r] -= a * i; } class Ut {
  constructor(e) { const t = e.conversionAccuracy === 'longterm' || !1; this.values = e.values, this.loc = e.loc || Ge.create(), this.conversionAccuracy = t ? 'longterm' : 'casual', this.invalid = e.invalid || null, this.matrix = t ? zt : Zt, this.isLuxonDuration = !0; }

  static fromMillis(e, t) { return Ut.fromObject({ milliseconds: e }, t); }

  static fromObject(e, t = {}) { if (e == null || typeof e !== 'object') throw new a(`Duration.fromObject: argument expected to be an object, got ${e === null ? 'null' : typeof e}`); return new Ut({ values: ee(e, Ut.normalizeUnit), loc: Ge.fromObject(t), conversionAccuracy: t.conversionAccuracy }); }

  static fromDurationLike(e) { if (Z(e)) return Ut.fromMillis(e); if (Ut.isDuration(e)) return e; if (typeof e === 'object') return Ut.fromObject(e); throw new a(`Unknown duration argument ${e} of type ${typeof e}`); }

  static fromISO(e, t) { const [r] = Ke(e, [lt, ct]); return r ? Ut.fromObject(r, t) : Ut.invalid('unparsable', `the input "${e}" can't be parsed as ISO 8601`); }

  static fromISOTime(e, t) { const [r] = Ke(e, [ut, Et]); return r ? Ut.fromObject(r, t) : Ut.invalid('unparsable', `the input "${e}" can't be parsed as ISO 8601`); }

  static invalid(e, t = null) { if (!e) throw new a('need to specify a reason the Duration is invalid'); t = e instanceof Te ? e : new Te(e, t); if (Ae.throwOnInvalid) throw new s(t); return new Ut({ invalid: t }); }
  ...
  plus(e) { if (!this.isValid) return this; const t = Ut.fromDurationLike(e); const r = {}; for (const n of qt)(q(t.values, n) || q(this.values, n)) && (r[n] = t.get(n) + this.get(n)); return jt(this, { values: r }, !0); }

  minus(e) { if (!this.isValid) return this; const t = Ut.fromDurationLike(e); return this.plus(t.negate()); }

  mapUnits(e) { if (!this.isValid) return this; const t = {}; for (const r of Object.keys(this.values))t[r] = X(e(this.values[r], r)); return jt(this, { values: t }, !0); }

  get(e) { return this[Ut.normalizeUnit(e)]; }

  set(e) { return this.isValid ? jt(this, { values: { ...this.values, ...ee(e, Ut.normalizeUnit) } }) : this; }

  reconfigure({ locale: e, numberingSystem: t, conversionAccuracy: r } = {}) { const n = this.loc.clone({ locale: e, numberingSystem: t }); const s = { loc: n }; return r && (s.conversionAccuracy = r), jt(this, s); }

  as(e) { return this.isValid ? this.shiftTo(e).get(e) : NaN; }

  normalize() { if (!this.isValid) return this; let r; let n; const e = this.toObject(); return r = this.matrix, n = e, At.reduce((e, t) => ($(n[t]) ? e : (e && _t(r, n, e, n, t), t)), null), jt(this, { values: e }, !0); }

  shiftTo(...e) { if (!this.isValid) return this; if (e.length === 0) return this; e = e.map((e) => Ut.normalizeUnit(e)); const t = {}; const r = {}; const n = this.toObject(); let s; for (const a of qt) if (e.indexOf(a) >= 0) { s = a; let e = 0; for (const o in r)e += this.matrix[o][a] * r[o], r[o] = 0; Z(n[a]) && (e += n[a]); const i = Math.trunc(e); t[a] = i, r[a] = e - i; for (const u in n)qt.indexOf(u) > qt.indexOf(a) && _t(this.matrix, n, u, t, a); } else Z(n[a]) && (r[a] = n[a]); for (const l in r)r[l] !== 0 && (t[s] += l === s ? r[l] : r[l] / this.matrix[s][l]); return jt(this, { values: t }, !0).normalize(); }

  negate() { if (!this.isValid) return this; const e = {}; for (const t of Object.keys(this.values))e[t] = -this.values[t]; return jt(this, { values: e }, !0); }
  ...
  equals(e) { if (!this.isValid || !e.isValid) return !1; if (!this.loc.equals(e.loc)) return !1; for (const n of qt) if (t = this.values[n], r = e.values[n], !(void 0 === t || t === 0 ? void 0 === r || r === 0 : t === r)) return !1; let t; let r; return !0; }
  ...
  static invalid(e, t = null) { if (!e) throw new a('need to specify a reason the Interval is invalid'); t = e instanceof Te ? e : new Te(e, t); if (Ae.throwOnInvalid) throw new n(t); return new Wt({ invalid: t }); }
  ...
  static after(e, t) { const r = Ut.fromDurationLike(t); const n = Rr(e); return Wt.fromDateTimes(n, n.plus(r)); }

  static before(e, t) { const r = Ut.fromDurationLike(t); const n = Rr(e); return Wt.fromDateTimes(n.minus(r), n); }

  static fromISO(e, s) { const [i, a] = (e || '').split('/', 2); if (i && a) { let e; let t; try { e = Wr.fromISO(i, s), t = e.isValid; } catch (a) { t = !1; }let r; let n; try { r = Wr.fromISO(a, s), n = r.isValid; } catch (a) { n = !1; } if (t && n) return Wt.fromDateTimes(e, r); if (t) { const o = Ut.fromISO(a, s); if (o.isValid) return Wt.after(e, o); } else if (n) { s = Ut.fromISO(i, s); if (s.isValid) return Wt.before(r, s); } } return Wt.invalid('unparsable', `the input "${e}" can't be parsed as ISO 8601`); }
  ...
  splitBy(e) { const t = Ut.fromDurationLike(e); if (!this.isValid || !t.isValid || t.as('milliseconds') === 0) return []; let{ s: r } = this; let n = 1; let s; const i = []; for (;r < this.e;) { const a = this.start.plus(t.mapUnits((e) => e * n)); s = +a > +this.e ? this.e : a, i.push(Wt.fromDateTimes(r, s)), r = s, n += 1; } return i; }
  ...
  toDuration(e, t) { return this.isValid ? this.e.diff(this.s, e, t) : Ut.invalid(this.invalidReason); }

  mapEndpoints(e) { return Wt.fromDateTimes(e(this.s), e(this.e)); }
} class Rt {
  static hasDST(e = Ae.defaultZone) { const t = Wr.now().setZone(e).set({ month: 12 }); return !e.isUniversal && t.offset !== t.set({ month: 6 }).offset; }

  static isValidIANAZone(e) { return Ee.isValidSpecifier(e) && Ee.isValidZone(e); }

  static normalizeZone(e) { return Ce(e, Ae.defaultZone); }
  ...
  var { weekYear: t, weekNumber: r, weekday: n } = e; const s = fr(t, 1, 4); var i = P(t); let a = 7 * r + n - s - 3; let o; a < 1 ? (o = t - 1, a += P(o)) : a > i ? (o = t + 1, a -= P(t)) : o = t; var { month: i, day: t } = gr(o, a); return {
    year: o, month: i, day: t, ...re(e),
  };
} function vr(e) { const { year: t, month: r, day: n } = e; return { year: t, ordinal: yr(t, r, n), ...re(e) }; } function Tr(e) {
  var { year: t, ordinal: r } = e; var { month: n, day: r } = gr(t, r); return {
    year: t, month: n, day: r, ...re(e),
  };
} function Sr(e) { const t = F(e.year); const r = A(e.month, 1, 12); const n = A(e.day, 1, J(e.year, e.month)); return t ? r ? !n && mr('day', e.day) : mr('month', e.month) : mr('year', e.year); } function br(e) {
  const {
...
} const Or = 'Invalid DateTime'; function kr(e) { return new Te('unsupported zone', `the zone "${e.name}" is not supported`); } function Mr(e) { return e.weekData === null && (e.weekData = wr(e.c)), e.weekData; } function Nr(e, t) {
  e = {
  ...
  const r = e.o; const n = e.c.year + Math.trunc(t.years); var s = e.c.month + Math.trunc(t.months) + 3 * Math.trunc(t.quarters); var s = {
    ...e.c, year: n, month: s, day: Math.min(e.c.day, J(n, s)) + Math.trunc(t.days) + 7 * Math.trunc(t.weeks),
  }; var t = Ut.fromObject({
...
} function xr(e, t, r, n, s) { const { setZone: i, zone: a } = r; if (e && Object.keys(e).length !== 0) { const o = t || a; const u = Wr.fromObject(e, { ...r, zone: o }); return i ? u : u.setZone(a); } return Wr.invalid(new Te('unparsable', `the input "${s}" can't be parsed as ${n}`)); } function Cr(e, t, r = !0) { return e.isValid ? ve.create(Ge.create('en-US'), { allowZ: r, forceSimple: !0 }).formatDateTimeFromString(e, t) : null; } function $r(e, {
  ...
  const r = Ce(t.zone, Ae.defaultZone); const n = Ge.fromObject(t); const s = Ae.now(); let i; let a; if ($(e.year))i = s; else { for (const o of zr)$(e[o]) && (e[o] = Zr[o]); t = Sr(e) || br(e); if (t) return Wr.invalid(t); t = r.offset(s); [i, a] = Vr(e, t, r); } return new Wr({
    ts: i, zone: r, loc: n, o: a,
  });
} function Ur(t, n, s) { const i = !!$(s.round) || s.round; const e = (e, t) => { e = W(e, i || s.calendary ? 0 : 2, !0); const r = n.loc.clone(s).relFormatter(s); return r.format(e, t); }; const r = (e) => (s.calendary ? n.hasSame(t, e) ? 0 : n.startOf(e).diff(t.startOf(e), e).get(e) : n.diff(t, e).get(e)); if (s.unit) return e(r(s.unit), s.unit); for (const o of s.units) { const a = r(o); if (Math.abs(a) >= 1) return e(a, o); } return e(n < t ? -0 : 0, s.units[s.units.length - 1]); } function Hr(e) { let t = {}; let r; return r = e.length > 0 && typeof e[e.length - 1] === 'object' ? (t = e[e.length - 1], Array.from(e).slice(0, e.length - 1)) : Array.from(e), [t, r]; } class Wr {
  constructor(e) { const t = e.zone || Ae.defaultZone; let r = e.invalid || (Number.isNaN(e.ts) ? new Te('invalid input') : null) || (t.isValid ? null : kr(t)); this.ts = $(e.ts) ? Ae.now() : e.ts; let n = null; let s = null; let i; r || (e.old && e.old.ts === this.ts && e.old.zone.equals(t) ? [n, s] = [e.old.c, e.old.o] : (i = t.offset(this.ts), n = Er(this.ts, i), r = Number.isNaN(n.year) ? new Te('invalid input') : null, n = r ? null : n, s = r ? null : i)), this._zone = t, this.loc = e.loc || Ge.create(), this.invalid = r, this.weekData = null, this.c = n, this.o = s, this.isLuxonDateTime = !0; }
  ...
  static utc() {
    const [e, t] = Hr(arguments); const [r, n, s, i, a, o, u] = t; return e.zone = Ie.utcInstance, _r({
      year: r, month: n, day: s, hour: i, minute: a, second: o, millisecond: u,
    }, e);
  }

  static fromJSDate(e, t = {}) { const r = Object.prototype.toString.call(e) === '[object Date]' ? e.valueOf() : NaN; if (Number.isNaN(r)) return Wr.invalid('invalid input'); e = Ce(t.zone, Ae.defaultZone); return e.isValid ? new Wr({ ts: r, zone: e, loc: Ge.fromObject(t) }) : Wr.invalid(kr(e)); }

  static fromMillis(e, t = {}) { if (Z(e)) return e < -864e13 || e > 864e13 ? Wr.invalid('Timestamp out of range') : new Wr({ ts: e, zone: Ce(t.zone, Ae.defaultZone), loc: Ge.fromObject(t) }); throw new a(`fromMillis requires a numerical input, but received a ${typeof e} with value ${e}`); }

  static fromSeconds(e, t = {}) { if (Z(e)) return new Wr({ ts: 1e3 * e, zone: Ce(t.zone, Ae.defaultZone), loc: Ge.fromObject(t) }); throw new a('fromSeconds requires a numerical input'); }

  static fromObject(e, t = {}) {
    e = e || {}; const r = Ce(t.zone, Ae.defaultZone); if (!r.isValid) return Wr.invalid(kr(r)); const n = Ae.now(); const s = r.offset(n); const i = ee(e, jr); const a = !$(i.ordinal); const o = !$(i.year); const u = !$(i.month) || !$(i.day); const l = o || u; const c = i.weekYear || i.weekNumber; const h = Ge.fromObject(t); if ((l || a) && c) throw new N("Can't mix weekYear/weekNumber units with year/month/day or ordinals"); if (u && a) throw new N("Can't mix ordinal dates with month/day"); const d = c || i.weekday && !l; let m; let f; let y = Er(n, s); d ? (m = qr, f = Fr, y = wr(y)) : a ? (m = Ar, f = Lr, y = vr(y)) : (m = zr, f = Zr); let g = !1; for (const M of m)$(i[M]) ? g ? i[M] = f[M] : i[M] = y[M] : g = !0; var w; let p; let v; let T; var w = (d ? (p = i, v = F(p.weekYear), t = A(p.weekNumber, 1, G(p.weekYear)), T = A(p.weekday, 1, 7), v ? t ? !T && mr('weekday', p.weekday) : mr('week', p.week) : mr('weekYear', p.weekYear)) : a ? (w = i, T = F(w.year), p = A(w.ordinal, 1, P(w.year)), T ? !p && mr('ordinal', w.ordinal) : mr('year', w.year)) : Sr(i)) || br(i); if (w) return Wr.invalid(w); const S = d ? pr(i) : a ? Tr(i) : i; const [b, O] = Vr(S, s, r); const k = new Wr({
      ts: b, zone: r, o: O, loc: h,
    }); return i.weekday && l && e.weekday !== k.weekday ? Wr.invalid('mismatched weekday', `you can't specify both a weekday of ${i.weekday} and a date of ${k.toISO()}`) : k;
  }

  static fromISO(e, t = {}) { const [r, n] = Ke(e, [Tt, kt], [St, Mt], [bt, Nt], [Ot, Dt]); return xr(r, n, t, 'ISO 8601', e); }

  static fromRFC2822(e, t = {}) { const [r, n] = Ke(e.replace(/\([^)]*\)|[\n\t]/g, ' ').replace(/(\s\s+)/g, ' ').trim(), [mt, ft]); return xr(r, n, t, 'RFC 2822', e); }

  static fromHTTP(e, t = {}) { var [r, e] = Ke(e, [yt, pt], [gt, pt], [wt, vt]); return xr(r, e, t, 'HTTP', t); }

  static fromFormat(e, t, r = {}) { if ($(e) || $(t)) throw new a('fromFormat requires an input string and a format'); var { locale: n = null, numberingSystem: s = null } = r; var [i, n, s] = (function (e, t, r) { var { result: e, zone: t, invalidReason: r } = cr(e, t, r); return [e, t, r]; }(Ge.fromOpts({ locale: n, numberingSystem: s, defaultToEN: !0 }), e, t)); return s ? Wr.invalid(s) : xr(i, n, r, `format ${t}`, e); }

  static fromString(e, t, r = {}) { return Wr.fromFormat(e, t, r); }

  static fromSQL(e, t = {}) { const [r, n] = Ke(e, [Vt, xt], [It, Ct]); return xr(r, n, t, 'SQL', e); }

  static invalid(e, t = null) { if (!e) throw new a('need to specify a reason the DateTime is invalid'); t = e instanceof Te ? e : new Te(e, t); if (Ae.throwOnInvalid) throw new r(t); return new Wr({ invalid: t }); }
  ...
  get daysInMonth() { return J(this.year, this.month); }

  get daysInYear() { return this.isValid ? P(this.year) : NaN; }
  ...
  setZone(t, { keepLocalTime: r = !1, keepCalendarTime: n = !1 } = {}) { if ((t = Ce(t, Ae.defaultZone)).equals(this.zone)) return this; if (t.isValid) { let e = this.ts; return (r || n) && (r = t.offset(this.ts), n = this.toObject(), [e] = Vr(n, r, t)), Nr(this, { ts: e, zone: t }); } return Wr.invalid(kr(t)); }
  ...
  set(e) { if (!this.isValid) return this; var t = ee(e, jr); var r = !$(t.weekYear) || !$(t.weekNumber) || !$(t.weekday); const n = !$(t.ordinal); const s = !$(t.year); const i = !$(t.month) || !$(t.day); var e = t.weekYear || t.weekNumber; if ((s || i || n) && e) throw new N("Can't mix weekYear/weekNumber units with year/month/day or ordinals"); if (i && n) throw new N("Can't mix ordinal dates with month/day"); let a; r ? a = pr({ ...wr(this.c), ...t }) : $(t.ordinal) ? (a = { ...this.toObject(), ...t }, $(t.day) && (a.day = Math.min(J(a.year, a.month), a.day))) : a = Tr({ ...vr(this.c), ...t }); var [r, t] = Vr(a, this.o, this.zone); return Nr(this, { ts: r, o: t }); }

  plus(e) { return this.isValid ? Nr(this, Ir(this, Ut.fromDurationLike(e))) : this; }

  minus(e) { return this.isValid ? Nr(this, Ir(this, Ut.fromDurationLike(e).negate())) : this; }

  startOf(e) { if (!this.isValid) return this; const t = {}; const r = Ut.normalizeUnit(e); switch (r) { case 'years': t.month = 1; case 'quarters': case 'months': t.day = 1; case 'weeks': case 'days': t.hour = 0; case 'hours': t.minute = 0; case 'minutes': t.second = 0; case 'seconds': t.millisecond = 0; } return r === 'weeks' && (t.weekday = 1), r === 'quarters' && (e = Math.ceil(this.month / 3), t.month = 3 * (e - 1) + 1), this.set(t); }

  endOf(e) { return this.isValid ? this.plus({ [e]: 1 }).startOf(e).minus(1) : this; }

  toFormat(e, t = {}) { return this.isValid ? ve.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e) : Or; }

  toLocaleString(e = c, t = {}) { return this.isValid ? ve.create(this.loc.clone(t), e).formatDateTime(this) : Or; }
  ...
  diff(e, t = 'milliseconds', r = {}) { if (!this.isValid || !e.isValid) return Ut.invalid('created by diffing an invalid DateTime'); r = { locale: this.locale, numberingSystem: this.numberingSystem, ...r }; const n = (t = t, (Array.isArray(t) ? t : [t]).map(Ut.normalizeUnit)); const s = e.valueOf() > this.valueOf(); const i = s ? this : e; const a = s ? e : this; const o = Jt(i, a, n, r); return s ? o.negate() : o; }
  ...
  static fromFormatExplain(e, t, r = {}) { var { locale: n = null, numberingSystem: r = null } = r; return cr(Ge.fromOpts({ locale: n, numberingSystem: r, defaultToEN: !0 }), e, t); }
...
} function Rr(e) { if (Wr.isDateTime(e)) return e; if (e && e.valueOf && Z(e.valueOf())) return Wr.fromJSDate(e); if (e && typeof e === 'object') return Wr.fromObject(e); throw new a(`Unknown datetime argument: ${e}, of type ${typeof e}`); }et = '2.1.1'; export {
  Wr as DateTime, Ut as Duration, Ie as FixedOffsetZone, Ee as IANAZone, Rt as Info, Wt as Interval, xe as InvalidZone, Ae as Settings, Oe as SystemZone, et as VERSION, Se as Zone,
};